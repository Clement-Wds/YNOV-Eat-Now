...
<div class="card" style="width: 35rem;">
    ...
    <div class="card-body">
        <a href="{{ url('/edit_profileRestorer') }}" class="btn btn-primary">Modifier</a>
        <a href="{{ url('/change_passwordRestorer') }}" class="btn btn-secondary">Modifier mon mot de passe</a>
